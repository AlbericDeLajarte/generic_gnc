...
/**
 * This describes the generic use of Eigen::AutoDiffScalar
 */
void generic_use_autodiff_scalar(){
    std::cout << "== generic_use_autodiff_scalar() ==" << std::endl;
